...
#define CIALLOHOOK_FEATURE_CUSTOM_PAK_CPK 1
#define CIALLOHOOK_FEATURE_CUSTOM_PAK_XP3 1
#define CIALLOHOOK_FEATURE_CUSTOM_PAK_LPK 1
...
#define CIALLOHOOK_FEATURE_RUNTIME_INIT 1
