...
namespace CialloHook
{
	inline void ApplyGuiBuiltInConfigOverrides(AppSettings& settings)
	{
		...
		settings.font.hookSelectObject = true;
		settings.font.hookGetCurrentObject = true;
		...
		settings.font.hookGetTextCharset = true;
		settings.font.hookGetTextCharsetInfo = true;
		...
		settings.engineCompat.artemisAggressiveCacheScan = false;
